...
class ExampleModel(nn.Module):
    ...
    def forward(self, x):
        """
        Performs a forward pass Forward pass through the fully-connected layers. through the model
        Args:
...
class Trainer:
    ...
    def __init__(self):
        ...
        #self.optimizer = torch.optim.SGD(self.model.parameters(), self.learning_rate, weight_decay=0.001, momentum = 0.2)
        self.optimizer = optim.Adam(self.model.parameters(), lr=self.learning_rate, weight_decay = 0.0004)
        # Load our dataset
...
if __name__ == "__main__":
    ...
    print("Final Training Accuracy: ", trainer.TEST_ACC[-trainer.early_stop_count])
